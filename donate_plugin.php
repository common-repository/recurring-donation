		...
		<div id="tabs" class="dntplgn_form_wrapper">
			...
			<div id="tabs-1">
				...
				<form class="dntplgn_donate_monthly"  action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top" class="dntplgn_form">
					...
					<input type="hidden" name="business" value="<?php echo esc_attr($merchant_account_email); ?>" />
					<input type="hidden" name="lc" value="US">
					<input type="hidden" name="item_name" value="<?php echo esc_attr($dntplgn_atts['item_name']); ?>">
					...
					<input type="hidden" name="currency_code" value="<?php echo esc_attr($currency_code); ?>">
                                        ...
                                        <input type="hidden" name="cancel_return" value="<?php echo esc_url($dntplgn_cancel_return); ?>" />
			...
			<div id="tabs-2">
				...
				<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
                                        <div class="dntplgn_once_enter_donation_label">
                                            ...
                                            <span class="dntplgn_payment_currency"><?php echo ' ('.esc_attr($currency_code).')'; ?></span>
                                        </div>
